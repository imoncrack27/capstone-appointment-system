    ...
    function bindEventHandlers() {
        ...
        $('#manage-appointment #save-appointment').on('click', function () {
            ...
            var customer = {
                ...
                dateOfBirth: $dialog.find('#date-of-birth').val(),
                motherMaidenName: $dialog.find('#mother-maiden-name').val(),
                programGraduatedEnrolled: $dialog.find('#program-graduated-enrolled').val(),
                yearGraduate: $dialog.find('#year-graduate').val(),
                nameOfSchool: $dialog.find('#name-of-school-honorable-dismissal-only').val(),
            };
