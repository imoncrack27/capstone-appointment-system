...
<head>
    ...
    <title>Installation | Appointment System</title>
...
<header>
    <div class="container">
        <h1 class="page-title">Appointment System Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the Appointment System installation page.</h3>
        <p>
            This page will help you set the main settings of your Appointment System installation.
            ...
            url to connect to the backend section of Appointment System.

            If you face any problems during the usage of Appointment System you can always check the
    ...
    <p>
    <h3>License</h3>
    Appointment System is licensed under the <span class="badge badge-default">GPL-3.0 license</span>.
    By using the code of Appointment System in any way <br> you agree with the terms described in the
    following url:
    ...
    <button type="button" id="install" class="btn btn-success btn-large">
        ...
        Install Appointment System
    </button>
</div>

<footer>
    Powered by <a href="https://easyappointments.org">Drexell Mingo</a>
</footer>
